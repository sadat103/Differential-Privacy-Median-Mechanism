...
if __name__ == '__main__':
    ...
    for j in np.arange(0.1, 0.9, 0.15):
        ...
        for i in np.arange(0, 15, 0.2):
            ...
            #forest3 = DP_Random_Forest(train_data3[1:35], test_data3, [0,], 2, 0.1)
            ...
            trees_list.append(i)
            accuracy_list.append(forest8._accuracy*100)
            print('accuracy = '+str(forest8._accuracy*100))
        print(trees_list)
        print(accuracy_list)
        ...
        plt.title('budget-accuracy curve for fixed trees')
        plt.xlabel('budget')
        plt.ylabel('accuracy')
