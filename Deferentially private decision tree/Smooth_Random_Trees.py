...
if __name__ == '__main__':
    ...
    for j in np.arange(0.5, 0.6, 0.1):
        ...
        for i in np.arange(10,21 , 5):
            ...
            #forest8 = DP_Random_Forest(train_data8[1:10], test_data8, [0,], 30,i)
            #forest9 = DP_Random_Forest(train_data9[1:4], test_data9, [0,], 15, i)
        ...
        plt.title('tree-accuracy curve for fixed budgets and train test ratio' +str(j))
        plt.xlabel('budgets')
        plt.ylabel('accuracy')
